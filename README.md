...
### Web 端专属
- **13 个功能页面** — 媒体库/设备列表/收藏设备/播放队列/播放历史/文件管理/统计面板/网络诊断/快捷键/多语言/数据导出/设置/关于
...
│       ├── HttpRangeServer.kt   HTTP+Range 服务 + 文件管理 + 扫描路径 API
