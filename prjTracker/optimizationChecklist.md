...
| # | 文件 | 位置 | 状态 | 建议 |
|---|------|------|------|------|
| 6 | `MainActivity.kt` | 5 处中文硬编码 | ⏳ | 提取至 `strings.xml` |
| 7 | `MediaServerService.kt` | 5 处通知栏硬编码 | ⏳ | 提取至 `strings.xml` |
| 8 | `MediaAdapter.kt` | 3 处类型标签硬编码 | ⏳ | 复用已有的 `@string/filter_video` 等 |
...
| # | 问题 | 文件 | 状态 | 建议 |
|---|------|------|------|------|
| 9 | 每次请求重编译 Regex | `HttpRangeServer.kt:88` | ⏳ | 提为 `companion object` 常量 |
...
| # | 问题 | 文件 | 状态 | 建议 |
|---|------|------|------|------|
| 13 | `emptyHint` 未使用的 TextView | `MainActivity.kt:33` | ⏳ | 改用 `findViewById(R.id.empty_hint)` |
...
| # | 问题 | 状态 | 建议 |
|---|------|------|------|
| 17 | R8 混淆未开启 | ⏳ | release 启用 `isMinifyEnabled = true` |
